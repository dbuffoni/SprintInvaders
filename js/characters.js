    ...
    this.meetingQuestions = [
      {
        ...
        options: [
          { text: "Two days, it's just a quick hash thing, right?", correct: true },
      ...
      },
      {
        ...
        options: [
          { text: "Four hours, I'll slap some buttons on it.", correct: true },
      ...
      },
      {
        ...
        options: [
          { text: "Ten minutes, it's probably just a typo.", correct: true },
          { text: "Depends—did anyone log it, or are we guessing?", correct: false, message: "Good catch! No ticket, no clue—let's move on before someone notices!" }
        ]
      },
      {
      ...
      },
      {
        ...
        options: [
          { text: "Next sprint, I'll just copy-paste ChatGPT to it.", correct: true },
      ...
      },
      {
        ...
        options: [
          { text: "Five points, it's basically JavaScript, right?", correct: true },
          { text: "Infinity points, because .... whaaat?", correct: false, message: "let's watch a tutorial together right now! " }
        ]
      }
    ];
  }
